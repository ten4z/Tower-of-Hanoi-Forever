...
const NLA_FRAME_PER_SECOND = 24;
const DEFAULT_CAM_TYPE = m_camera.MS_STATIC;

// const HIDE_MENU_DELAY          = 20000000;
// const ANIM_ELEM_DELAY          = 50;
// const LOGO_SHOW_DELAY          = 300;
// const LOGO_HIDE_DELAY          = 300;
// const LOGO_CIRCLE_HIDE_DELAY   = 300;
// const CAPTION_SHOW_DELAY       = 300;
// const CAPTION_HIDE_DELAY       = 300;
// const MENU_BUTTON_SHOW_DELAY   = 300;
// const PRELOADER_HIDE_DELAY     = 300;
...
function play_engine() {
    ...
    if (m_main.is_paused()) {
        let cur_sec = cur_frame / NLA_FRAME_PER_SECOND;
        let nla_sec_lenght = nla_frame_length / NLA_FRAME_PER_SECOND;
